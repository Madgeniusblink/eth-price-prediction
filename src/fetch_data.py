...
def main():
    ...
    if df_1m is not None:
        df_1m.to_csv('/home/ubuntu/eth_1m_data.csv', index=False)
    ...
    if df_5m is not None:
        df_5m.to_csv('/home/ubuntu/eth_5m_data.csv', index=False)
    ...
    if df_15m is not None:
        df_15m.to_csv('/home/ubuntu/eth_15m_data.csv', index=False)
    ...
    if df_cg is not None:
        df_cg.to_csv('/home/ubuntu/eth_coingecko_data.csv', index=False)
    ...
    metadata = {
        ...
        'data_files': {
            '1m': '/home/ubuntu/eth_1m_data.csv',
            '5m': '/home/ubuntu/eth_5m_data.csv',
            '15m': '/home/ubuntu/eth_15m_data.csv',
            'coingecko': '/home/ubuntu/eth_coingecko_data.csv'
        }
    }
    
    with open('/home/ubuntu/eth_data_metadata.json', 'w') as f:
